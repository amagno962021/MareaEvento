sap.ui.define([
	...
	return ManagedObject.extend("com.tasa.mareaevento.controller.Biometria", {
        ...
        getDialog_add_especie: function () {
            if (!this.oDialog_e) {
                this.oDialog_e = sap.ui.xmlfragment("com.tasa.mareaevento.fragments.Popup_especie", this);
        ...
        getDialog_add_Incidental: function () {
            if (!this.oDialog_I) {
                this.oDialog_I = sap.ui.xmlfragment("com.tasa.mareaevento.fragments.Popup_Incidental", this);
