    ...
    return Controller.extend("com.tasa.mareaevento.controller.MainComp", {
        ...
        setDetalleMarea: async function (data, navegar) {
            ...
            if (navegar) {
                ...
                BusyIndicator.show(0);
                sap.ui.controller("com.tasa.mareaevento.controller.Marea").validaFechaNulaEvt(this);
                await sap.ui.controller("com.tasa.mareaevento.controller.Marea").cargarCombos(this);
                await sap.ui.controller("com.tasa.mareaevento.controller.Marea").validarVista(this);
                BusyIndicator.hide();
            }
