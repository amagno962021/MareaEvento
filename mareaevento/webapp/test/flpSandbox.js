		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MareaEvento",
									"targetURL": "#comtasamareaevento-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtasamareaevento-display": {
								"semanticObject": "comtasamareaevento",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.mareaevento",
									"url": sap.ui.require.toUrl("com/tasa/mareaevento")
								}
							}
						}
					}
